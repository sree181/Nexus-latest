...
**Release candidate:** `manus/hypermesh-evidence-foundation-v1`
...
| Complete Python/API suite              | **501 passed, 1 skipped**                                                                                                                                                                                                                    |
...
| Stage 1 image rebuild                   | Not completed in this sandbox: the disposable VFS Docker data root exhausted the host inode quota while unpacking pinned base images. The Stage 1 source passed the full non-container release gate and a real hosted EngineGateway lifecycle; CI/deployment must still build and smoke the promoted image. |

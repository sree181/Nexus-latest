...
- Priority 5E release qualification with fresh non-root API/web images, durable EngineGateway container smoke, role-isolation verification, checksum-verified backup and clean restore to application health, a portable Mac/Cursor setup guide, read-only demo preflight, real-data presenter runbook, client checklist, corrected package manifest, and editable enterprise PowerPoint.

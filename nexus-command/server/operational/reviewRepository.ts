      ...
      agentFindings: [
        {
          ...
          agentName: 'NEXUS',
          status: 'contributed',
          observation: 'ATLAS, ECHO contributed. AQUA had no evidence to offer.',
          interpretation: 'The desks do not fully agree. ECHO: A Nexus-drafted traveler message could contradict what ALDOT is already displaying on this approach.',
          candidateAction: 'Activate the pre-approved remote-lot wayfinding plan and stage the next two available shuttles.',
          confidence: null,
          limitations: 'This recommendation was composed without AQUA. Treat parking occupancy as unassessed, not as clear.',
          citedEvidenceIds: ['55555555-5555-4555-8555-555555555551', '55555555-5555-4555-8555-555555555553'],
          conflicts: [{
            withAgentCode: 'atlas',
            concern: 'A Nexus-drafted traveler message could contradict what ALDOT is already displaying on this approach.',
            basis: 'An ALDOT message sign is already showing traveler text on this corridor.',
          }],
          createdAt: iso(-5),
        },
        {
          ...
          agentName: 'ATLAS',
          status: 'contributed',
          observation: 'Approach speed has remained below the event threshold for eight minutes.',
          interpretation: 'Approach capacity is already reduced, so a change here will land on a corridor with little headroom.',
          candidateAction: 'Confirm the corridor picture with traffic operations before committing to a routing or messaging change.',
          confidence: 0.68,
          limitations: 'Probe-derived speed only. ATLAS cannot change a signal plan.',
        ...
        },
        {
          ...
          agentName: 'ECHO',
          status: 'contributed',
          observation: 'ALDOT is already displaying traveler text on this approach.',
          interpretation: 'The state operator is already communicating, so any local message has to be consistent with it.',
          candidateAction: 'Draft traveler language for the communications owner to review. ECHO does not send it.',
          confidence: 0.55,
          limitations: 'Message-sign text only. ECHO cannot send a public alert.',
          citedEvidenceIds: ['55555555-5555-4555-8555-555555555551'],
          conflicts: [{
            withAgentCode: 'atlas',
            concern: 'A Nexus-drafted traveler message could contradict what ALDOT is already displaying on this approach.',
        ...
        },
        {
          ...
          agentName: 'AQUA',
          status: 'abstained',
          observation: 'No Auburn Parking Occupancy feed is connected, so AQUA cannot evaluate this incident.',
          interpretation: 'Balance parking, remote-lot, curb, and shuttle demand. Nexus holds no evidence that lets AQUA speak to this incident.',
          candidateAction: 'None. This desk is silent by design rather than in agreement.',
          confidence: null,
          limitations: 'AQUA cannot change an operator schedule or parking policy without agency authorization.',
          citedEvidenceIds: [],
          conflicts: [],
          createdAt: iso(-5),
        },
  ...
  async scenarioPacks(): Promise<ScenarioPack[]> {
    return [
      ...
      },
      {
        ...
        name: 'Campus and city mobility',
        eventType: 'sec_gameday',
        description: 'Full desk roster for campus and city mobility.',
